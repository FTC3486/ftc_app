...
/*
    ...
    Description:
        This Range Sensor class allows the rover to access two different range sensors at once. The
    ...
    rover to use in a teleop or autonomous setting. A range sensor object should be created in the
    hardware configuration and accessed from a teleop file using an associated rover object. For
    example, type rover.hardwareConfiguration.rangeSensor.getUltraSonicRange() (using the specific
    rover class, hardware configuration, and rangeSensor objects) to access the data from a specific
    sensor.
