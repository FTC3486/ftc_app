...

    {
        ...
        switch (v_state) {
            ...
            case 25:
                ...
                telemetry.addData("lb encoder", leftback.getCurrentPosition());
                telemetry.addData("rb encoder", rightback.getCurrentPosition());
                if(Math.abs(leftback.getCurrentPosition()) > 1000 && Math.abs(rightback.getCurrentPosition()) > 1000) {
                    blockGate.setPosition(bgclose);
                    resetStartTime();
                    waitTime = 2;
                    v_state++;
            ...
            case 30:
                ...
                telemetry.addData("lb encoder", leftback.getCurrentPosition());
                telemetry.addData("rb encoder", rightback.getCurrentPosition());
                if(Math.abs(leftback.getCurrentPosition()) > 1300 && Math.abs(rightback.getCurrentPosition()) > 1300) {
                    v_state++;
                }
                break;
